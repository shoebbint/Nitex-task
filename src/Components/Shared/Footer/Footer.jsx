      ...
      <footer className="header-text w-9/12 text-white body-font">
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center ">
            ...
            <div className="lg:w-1/3 md:w-1/2 w-full px-20">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a href="#service" className="text-white hover:text-gray-800">Services</a>
                </li>
                <li>
                  <a href="#projects" className="text-white hover:text-gray-800">Projects</a>
                </li>
                <li>
                  <a href="#review" className="text-white hover:text-gray-800">Reviews</a>
                </li>
                <li>
                  <a href="#faq" className="text-white hover:text-gray-800">Faqs</a>
                </li>
                <li>
        ...
        <div className="">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 all rights reserved —
              <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-white ml-1" target="_blank">Soyeb bin taher</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a href="https://www.facebook.com/rj.badhon.5" className="text-blue-500">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
              </a>
              <a href="https://github.com/shoebbint" className="ml-3 text-blue-700">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/soyeb-bin-taher-badhon-a0aa9122b/" className="ml-3 text-red-500">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                  <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/soyeb-bin-taher-badhon-a0aa9122b/" className="ml-3 text-white-500">
